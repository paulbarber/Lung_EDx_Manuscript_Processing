...
Here we want only the GAN_AE 32 DL model as it is simpler and has better interpretation.
...
# ONLY GAN32
dl_train <- dl_train[, c(1, grep("^GAN32", names(dl_train)))]
dl_test <- dl_test[, c(1, grep("^GAN32", names(dl_test)))]

data_namecv <- "flow_texrad_dl"
