...
train_set <- cbind(flow_train, texrad_train[, -1])
test_set <- cbind(flow_test, texrad_test[, -1])

groups <- c(rep(1, ncol(flow_train)-1), rep(2, ncol(texrad_train)-1))
group_names <- c("flow", "texrad")
