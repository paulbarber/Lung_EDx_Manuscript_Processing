...
train_set <- cbind(dl_train, texrad_train[, -1])
test_set <- cbind(dl_test, texrad_test[, -1])

groups <- c(rep(1, ncol(dl_train)-1), rep(2, ncol(texrad_train)-1))
group_names <- c("dl", "texrad")
