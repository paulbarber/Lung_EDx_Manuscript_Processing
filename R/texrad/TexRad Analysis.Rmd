...
(for some reason this will no longer run within knitr for these data! The msawrapper function produces an error.
Is the same version used in RStudio and knitr?
So, for now this chuck should be run manually when making the signatures, but eval=FALSE for knitr sothat the pdf is produced.)
...
strict_Predicted_response <- predictElasticNet(ElasNet_model, test_set[, train_msa$colLabels], 
